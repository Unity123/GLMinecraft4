...
//        ClientInstance instance = new ClientInstance(new ClientConfig("localhost", 3333));
        ...
        System.getProperties().keySet().stream().sorted(Comparator.comparing(Object::toString)).forEach(key -> {
            System.out.println(key + ": " + System.getProperties().get(key));
        });
        AtlasPosition grassSide = blocks.get(new Identifier("minecraft:block_grass_side"));
        AtlasPosition grassTop = blocks.get(new Identifier("minecraft:block_grass_top"));
        AtlasPosition grassOverlay = blocks.get(new Identifier("minecraft:block_grass_side_overlay"));
        AtlasPosition dirt = blocks.get(new Identifier("minecraft:block_dirt"));
        AtlasPosition none = blocks.get(new Identifier("minecraft:block_none"));
